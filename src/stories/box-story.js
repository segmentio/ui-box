...
const RedBox = props => <Box backgroundColor='red' width='100px' height='100px' margin='20px' {...props} />
  ...
  storiesOf('Box', module)
    ...
    .add('background', () => (
      <Box>
        ...
        <Box backgroundImage='url(https://s-media-cache-ak0.pinimg.com/736x/07/c3/45/07c345d0eca11d0bc97c894751ba1b46.jpg)'
